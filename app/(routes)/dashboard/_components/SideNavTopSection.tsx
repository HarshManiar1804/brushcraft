            ...
            <Popover>
                <PopoverTrigger>
                    <div className="flex items-center gap-3 hover:bg-slate-200 p-2 rounded-lg cursor-pointer">
                        ...
                        <h2 className="flex gap-2 items-center font-bold text-[17px]">Team Name
                ...
                <PopoverContent className='ml-7 p-4'>
                    ...
                    <div className="">
                        {menu.map((item, index) => {
                            return (
                                <h2 className='flex item-center gap-2 p-2 hover:bg-gray-200 rounded-lg cursor-pointer' key={index}>
